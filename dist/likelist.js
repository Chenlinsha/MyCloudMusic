...
function _getLikelist() {
  _getLikelist = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
    var res, ids;
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.next = 2;
            return getFetch("http://redrock.udday.cn:2022/likelist?uid=".concat(userid, "&cookie=").concat(cookie));

          case 2:
            res = _context4.sent;
            ids = res.ids;
            ids.forEach( /*#__PURE__*/function () {
              var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(ele, i) {
                var data, ul;
                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        _context3.next = 2;
                        return getFetch("http://redrock.udday.cn:2022/song/detail?ids=".concat(ids[i]));

                      case 2:
                        data = _context3.sent;
                        ul = document.querySelector('.songs1');
                        data.songs.forEach(function (ele, i) {
                          songerlist.push(data.songs[i].ar[0].name);
                          names.push(data.songs[i].name);
                          var li = document.createElement("li");
                          li.setAttribute('class', 'onesong');
                          li.innerHTML = "<img src=\"../images/love.PNG\" > <img src=\"../images/download.PNG\" ><span class=\"num\">".concat(i < 9 ? "0" + (i + 1) : i + 1, "</span><span class=\"name2\">").concat(data.songs[i].name, "</span><span\n            class=\"songer2\">").concat(data.songs[i].ar[0].name, "</span><span class=\"cd\"></span>");
                          buttonpic.push(data.songs[i].al.picUrl);
                          ul.appendChild(li);
                          pic.src = data.songs[i].al.picUrl;
                          li['onclick'] = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
                            var id, res;
