...
function _getDetail() {
  _getDetail = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
    var res;
    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return getFetch("http://redrock.udday.cn:2022/playlist/detail?id=".concat(lid));
          ...
          case 2:
            ...
            res.forEach(function (ele, i) {
              ...
              li.innerHTML = "<span class=\"num\">".concat(i < 9 ? "0" + (i + 1) : i + 1, "</span><img src=\"../images/love.PNG\" > <img src=\"../images/download.PNG\" ><span class=\"name2\">").concat(res[i].name, "</span><span\n        class=\"songer2\">").concat(res[i].ar[0].name, "</span><span class=\"cd\"></span>");
              ...
              smallli['onclick'] = function () {
                ...
                for (var _i = 0; _i < lis.length; _i++) {
                  console.log(lis);
                  lis[_i].style.color = "black";
                  smallli.style.color = "red";
                }

                songer2.innerHTML = res[i].ar[0].name;
                song1.innerHTML = res[i].name;
                var data = getFetch("http://redrock.udday.cn:2022/song/url?id=".concat(id));
                  ...
                  while (1) {
                    switch (_context4.prev = _context4.next) {
                      case 0:
                        buttoning.src = src1;
                        songer2.innerHTML = res[i].ar[0].name;
                        lis.forEach(function (ele, j) {
                          lis[j].style.color = "black";
                          smallli.style.color = "red";
                        });
                        song1.innerHTML = res[i].name;
                        _context4.next = 6;
                        return getFetch("http://redrock.udday.cn:2022/song/url?id=".concat(id));
...
up.onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
  var res;
  return regeneratorRuntime.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return getFetch("http://redrock.udday.cn:2022/song/url?id=".concat(ids[index]));
...
down1.onclick = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
  var res;
