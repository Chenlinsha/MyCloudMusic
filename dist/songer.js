...
__webpack_require__.e(/*! import() */ "src_css_songer_css").then(__webpack_require__.bind(__webpack_require__, /*! ../css/songer.css */ "./src/css/songer.css"));
...
var index = document.querySelector('#tab2');
var songlist = document.querySelector('#tab3');
var ints = [];
var catgs = [];
var i;
ints.push(int);
...
catgs[3] = 3;
console.log(int);
int.forEach(function (ele, i) {
  int[i].addEventListener('click', function () {
    int.forEach(function (ele, j) {
      int[j].style.color = "black";
      int[i].style.color = "red";
    });
  });
});
catLi.forEach(function (ele, i) {
  catLi[i].addEventListener('click', function () {
    catLi.forEach(function (ele, j) {
...
catLi.forEach(function (item, i) {
  item.addEventListener('click', function () {
    myRemove(); // cat ? cat = catgs[i] : cat = -1;
...
songlist.onclick = function () {
  return window.location.replace("..\\html\\listdt.html");
};
